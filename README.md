...
scripts/                 preflight · view_kinematic · view_mujoco · run_isaac (interactive) · convert_to_usd · setup_omniverse
src/gardener_bdx/
...
- [`docs/ISAACSIM.md`](docs/ISAACSIM.md) — **interactive** Isaac Sim: drive/inspect the twin in the GUI.
